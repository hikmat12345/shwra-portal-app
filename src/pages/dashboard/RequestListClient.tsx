...
import { getClientRequestList } from '../../redux/slices/request';
// utils
...
export default function RequestListClient() {
  ...
  // console.log("isRequestEmpty", filteredRequests && filteredRequests.length < 0)

  // console.log("isRequestEmpty", filteredRequests.length > 0)
          ...
          <Scrollbar>
            <TableContainer sx={{ minWidth: 800 }}>
              <Table>
                ...
                {/* !isRequestEmpty &&  <RequestListLoading /> */}
