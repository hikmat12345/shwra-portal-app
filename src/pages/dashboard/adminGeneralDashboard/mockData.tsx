...
export const monthChartData = [
  ...
  { month: 'May', earnings: 10000 },
  { month: 'Jun', earnings: 15550 },
  { month: 'Jul', earnings: 14250 },
  { month: 'Aug', earnings: 15000 },
  { month: 'Sep', earnings: 25000 },
  { month: 'Oct', earnings: 4000 },
  { month: 'Nov', earnings: 30000 },
  { month: 'Dec', earnings: 30000 }
];
export const reproduceMonthChartData = monthChartData?.map((data) => {
  return {
    month: data?.month,
    earnings: data?.earnings / 1000
  };
...
export const TABLE_HEAD = [
  ...
  { id: 'totalAppointments', label: 'مجموع المواعيد', alignRight: false },
  { id: 'lastAppointments', label: 'آخر موعد', alignRight: false },
  { id: 'income', label: 'الإيرادات', alignRight: false },
