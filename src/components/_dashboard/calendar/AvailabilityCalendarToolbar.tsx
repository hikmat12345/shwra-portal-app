...
const VIEW_OPTIONS = [
  ...
  { value: 'timeGridWeek', label: 'اسبوع', icon: roundViewWeek },
  { value: 'timeGridDay', label: 'يوم', icon: roundViewDay }
...
type AvailabilityCalendarToolbarProps = {
  date: Date;
  view: CalendarView;
...
export default function AvailabilityCalendarToolbar({
  date,
  view,
  onNextDate,
  onPrevDate,
  onToday,
  onChangeView
}: AvailabilityCalendarToolbarProps) {
  return (
    <RootStyle>
