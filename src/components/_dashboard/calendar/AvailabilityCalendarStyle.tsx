...
const CalendarStyles = styled('div')(({ theme,todaycolor }: any) => ({
  width: 'calc(100% + 2px)',
  marginLeft: -1,
  marginBottom: -1,
  '& .fc': {
    ...
    '--fc-today-bg-color': todaycolor || theme.palette.action.selected,
...
type AvailabilityCalendarStyleProps = {
  children: ReactNode;
  todaycolor?: string | null;
};
const AvailabilityCalendarStyle = ({ children, todaycolor }: AvailabilityCalendarStyleProps) => {
  return <CalendarStyles todaycolor={todaycolor}>{children}</CalendarStyles>;
};
